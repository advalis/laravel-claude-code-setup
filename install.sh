...
check_laravel_project() {
    if [ ! -f "artisan" ] || [ ! -f "composer.json" ]; then
        ...
        echo "  curl -fsSL https://raw.githubusercontent.com/advalis/laravel-claude-code-setup/main/install.sh | bash"
        echo ""
        exit 1
    fi
...
run_setup() {
    ...
    if git clone --quiet https://github.com/advalis/laravel-claude-code-setup.git "$TEMP_DIR"; then
...
main() {
    ...
    echo ""
    echo "📖 Documentation: https://github.com/advalis/laravel-claude-code-setup"
    echo "🆘 Need help? https://github.com/advalis/laravel-claude-code-setup/issues"
    echo ""
}
